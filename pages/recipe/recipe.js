...
Page({
  ...
  goSearchResult: function (event){
    ...
    app.getEventLog("301", "菜谱页面点击每个菜谱按钮(" + event.currentTarget.dataset.name + ")", event.currentTarget.dataset.typeid, event.currentTarget.dataset.subtypeid);
    wx.navigateTo({
  ...
  */
  onHide: function () {
    if (this.data.time1 != "" && this.data.time1 != null) {
      ...
      app.getPageTimer("300", "菜谱页面", "", "", vtime, this.data.time2);
    }
  },
