<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/adnim/SiteAdmin.Master" CodeBehind="VTestGrid.aspx.cs"  Inherits="EntityClass.VTestGrid" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptBlock" runat="server">
    ...
    <script type="text/javascript">
      ...
      //  $(function () {
        	var mygridinfo = {
		    url: 'handler/information.ashx?_op=VTestQuery',
		    editurl: 'handler/information.ashx?_op=VTest',
		    caption:''
				}
                        ...
                        formatoptions: {
                            ...
                            delOptions: deloption,
                          				    	...
                          				    	,searchtype: 'text',
			                     					                     				...
			                     					                     				{   name: 'NoEdit1', index: 'NoEdit1', width: 90 ,searchoptions: {sopt:['cn', 'eq', 'ne', 'bw', 'ew']},editable: true},
																					                     			              
		                     		                     	                    
										
                    			
			                          			 		       									                  			                     			                     														                     		
			                     					                     				{   name: 't1', index: 't1', width: 90 ,searchoptions: {sopt:['cn', 'eq', 'ne', 'bw', 'ew']},editable: true},
