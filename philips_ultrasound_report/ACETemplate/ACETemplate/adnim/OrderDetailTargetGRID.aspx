<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/adnim/SiteAdmin.Master" CodeBehind="OrderDetailTargetGrid.aspx.cs"  Inherits="ACETemplate.adnim.OrderDetailTargetGrid" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptBlock" runat="server">
	...
	<script>
	    ...
	    function ImportExcel(eid) {
	        ...
	        $.ajaxFileUpload({
	            url: "handler/ImportHandler.ashx?_op=QueryOrderDetail",
	            secureuri: false,
	            fileElementId: eid,
	            dataType: 'json',
	            beforeCall: function () {
