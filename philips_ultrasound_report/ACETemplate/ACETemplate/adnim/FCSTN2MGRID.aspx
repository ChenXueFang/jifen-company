<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/adnim/SiteAdmin.Master" CodeBehind="FCSTN2MGRID.aspx.cs" Inherits="ACETemplate.adnim.FCSTN2MGRID" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptBlock" runat="server">
	...
	<script>
	    ...
	    function ImportExcel(eid) {
	        ...
	        $.ajaxFileUpload({
	            url: "handler/ImportHandler.ashx?_op=QueryFCSTN2M",
	            secureuri: false,
	            fileElementId: eid,
	            dataType: 'json',
	            beforeCall: function () {
