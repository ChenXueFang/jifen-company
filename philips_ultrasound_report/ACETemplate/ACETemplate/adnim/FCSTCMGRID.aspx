<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/adnim/SiteAdmin.Master" CodeBehind="FCSTCMGRID.aspx.cs" Inherits="ACETemplate.adnim.FCSTCMGRID" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptBlock" runat="server">
	...
	<script>
	    ...
	    function ImportExcel(eid) {
	        ...
	        $.ajaxFileUpload({
	            url: "handler/ImportHandler.ashx?_op=QueryFCSTCM",
	            secureuri: false,
	            fileElementId: eid,
	            dataType: 'json',
	            beforeCall: function () {
