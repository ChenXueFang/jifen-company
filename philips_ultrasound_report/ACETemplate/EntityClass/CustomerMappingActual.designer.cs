...
[ActiveRecord("CustomerMappingActual")]
public partial class CustomerMappingActual: ActiveRecordBase<CustomerMappingActual> 
{
    ...
    {
        return CustomerMappingActual.Count(criteria);
    }
