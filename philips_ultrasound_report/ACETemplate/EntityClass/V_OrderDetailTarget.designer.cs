...
[ActiveRecord("V_OrderDetailTarget")]
public partial class V_OrderDetailTarget: ActiveRecordBase<V_OrderDetailTarget> 
{
	...
	public string Country
	{
		get { return _country; }
			...
			[Property("NewArea", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string NewArea
	{
		get { return _newArea; }
			...
			[Property("NewRegion", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	...
	public string SO
	{
		get { return _sO; }
			...
			[Property("SalesName", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	...
	public int Qty
	{
		get { return _qty; }
			...
			[Property("Channel", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string Channel
	{
		get { return _channel; }
			...
			[Property("DealerManual", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	...
	public string HospFlag
	{
		get { return _hospFlag; }
			...
			[Property("CustomerID", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string CustomerID
	{
		get { return _customerID; }
			...
			[Property("CustomerDICName", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 100)]
	...
	public string SAPSalesName
	{
		get { return _sAPSalesName; }
			...
			[Property("SAPShiptoParty", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string SAPShiptoParty
	{
		get { return _sAPShiptoParty; }
			...
			[Property("SAPSoldtoParty", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string SAPSoldtoParty
	{
		get { return _sAPSoldtoParty; }
			...
			[Property("Segent", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string Segent
	{
		get { return _segent; }
			...
			[Property("USOITDate", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string USOITDate
	{
		get { return _uSOITDate; }
			...
			[Property("AdjustmentRemark", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 200)]
	public string AdjustmentRemark
	{
		get { return _adjustmentRemark; }
			...
			[Property("HospitalType", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string HospitalType
	{
		get { return _hospitalType; }
			...
			[Property("HWORSW", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
	public string HWORSW
	{
		get { return _hWORSW; }
			...
			[Property("Solution", Access = PropertyAccess.NosetterCamelcaseUnderscore, NotNull = true, Length = 50)]
    ...
    {
        return V_OrderDetailTarget.Count(criteria);
    }
} // V_OrderDetailTarget
