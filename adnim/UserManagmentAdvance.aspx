<%@ Page Title="" Language="C#" MasterPageFile="~/adnim/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="UserManagmentAdvance.aspx.cs" Inherits="Web.adnim.UserManagmentAdvance" %>

<%@ Register Src="~/adnim/include/HeadNavigation.ascx" TagName="head" TagPrefix="user" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <user:head ID="user1" runat="server" Level2Name="管理" Level3Name="用户管理" />
