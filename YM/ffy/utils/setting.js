var setting = {
  ...
  defaultUrl:'https://www.mylife.philips.com.cn/ffymwebapi',
  defaultImgUrl:'https://www.mylife.philips.com.cn/ffymadnim/',
  appid:"wxca854fb450069cea",
...
// debugger
  ...
  console.log('setting.GET:' + setting.url + url);
  // debugger;
  wx.request({
    url: setting.url + url,
    data: data,
