...
Component({
  ...
  methods: {
    _onInit() {
      ...
      pickerArray[0] = tpData.time;
      pickerArray[1] = tpData.division;
      let mdate = {
        date: date,
    ...
    pickerChange: function (e) {
      ...
      const time = this.data.pickerArray[0][indexArr[3]].id;
      const division = this.data.pickerArray[1][indexArr[4]].id;
      let date = {
        date: new Date(time + ':' + division),
        // year: year + '',
      ...
      date.dateString = date.time + ':' + date.division;
      // console.log(date);
      this.setData({
    ...
    pickerColumnChange: function (e) {
      ...
      let cYear = data.pickerArray[0][data.pickerIndex[2]].id;
      let cMonth = data.pickerArray[1][data.pickerIndex[3]].id;
      let cDay = data.pickerArray[2][data.pickerIndex[4]].id;
      let cTime = data.pickerArray[0][data.pickerIndex[0]].id;
      let cDivision = data.pickerArray[1][data.pickerIndex[1]].id;
      ...
      data.pickerArray[2] = tpData.year;
      data.pickerArray[3] = tpData.month;
      data.pickerArray[4] = tpData.day;
      data.pickerArray[0] = tpData.time;
      data.pickerArray[1] = tpData.division;
