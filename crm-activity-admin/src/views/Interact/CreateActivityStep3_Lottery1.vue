        ...
        <div class="editCenter">
          ...
          <div class="lottery scollWrap" v-show="isLoaded">
            <div
              ...
              :style="{backgroundImage:'url(' + getSrc(PageConfig.pagebg.NewImgUrl?PageConfig.pagebg.NewImgUrl:PageConfig.pagebg.ImgUrl) + ')'}"
            >
              <div class="lotteryHeader">
                <img
                  ...
                  :src="getSrc(PageConfig.pagetitle.NewImgUrl?PageConfig.pagetitle.NewImgUrl:PageConfig.pagetitle.ImgUrl)"
                />
              </div>
              <img
                class="record"
                ...
                :src="getSrc(PageConfig.winrecord.NewImgUrl?PageConfig.winrecord.NewImgUrl:PageConfig.winrecord.ImgUrl)"
              />
              <div
                class="lottorybg"
                :class="{'choosedArea':PageConfig.turntablebg.IsChoosed}"
                @click.stop="editDetails('turntablebg',PageConfig.turntablebg)"
                :style="{backgroundImage:'url(' + getSrc(PageConfig.turntablebg.NewImgUrl?PageConfig.turntablebg.NewImgUrl:PageConfig.turntablebg.ImgUrl) + ')'}"
              >
                <div class="container" id="container">
                  ...
                  >
                    <img :src="getSrc(PageConfig.turntablestart.NewImgUrl?PageConfig.turntablestart.NewImgUrl:PageConfig.turntablestart.ImgUrl)" class="btn" />
                  </div>
                  <!-- 奖品扇形区域 -->
                  <ul class="pie">
                    <li class="slice-one slice" :style="{background:PageConfig.prize8bg.NewColorName16?PageConfig.prize8bg.NewColorName16:PageConfig.prize8bg.ColorName16}" ></li>
                    <li class="slice-two slice" :style="{background:PageConfig.prize7bg.NewColorName16?PageConfig.prize7bg.NewColorName16:PageConfig.prize7bg.ColorName16}" ></li>
                    <li class="slice-three slice" :style="{background:PageConfig.prize6bg.NewColorName16?PageConfig.prize6bg.NewColorName16:PageConfig.prize6bg.ColorName16}" ></li>
                    <li class="slice-four slice" :style="{background:PageConfig.prize5bg.NewColorName16?PageConfig.prize5bg.NewColorName16:PageConfig.prize5bg.ColorName16}" ></li>
                    <li class="slice-five slice" :style="{background:PageConfig.prize4bg.NewColorName16?PageConfig.prize4bg.NewColorName16:PageConfig.prize4bg.ColorName16}" ></li>
                    <li class="slice-six slice" :style="{background:PageConfig.prize3bg.NewColorName16?PageConfig.prize3bg.NewColorName16:PageConfig.prize3bg.ColorName16}" ></li>
                    <li class="slice-seven slice" :style="{background:PageConfig.prize2bg.NewColorName16?PageConfig.prize2bg.NewColorName16:PageConfig.prize2bg.ColorName16}" ></li>
                    <li class="slice-eight slice" :style="{background:PageConfig.prize1bg.NewColorName16?PageConfig.prize1bg.NewColorName16:PageConfig.prize1bg.ColorName16}" ></li>
                  </ul>
                  <!-- 奖品扇形区域选中蒙板定位 -->
                  <ul class="pie1">
                  ...
                  <ul class="pieEle">
                    <li>
                      <div class="name-one name" :class="{'choosedArea':PageConfig.prize6name.IsChoosed}" @click.stop="editDetails('prize6name',PageConfig.prize6name)" :style="{color:PageConfig.prize6name.NewColorName16?PageConfig.prize6name.NewColorName16:PageConfig.prize6name.ColorName16}" >谢谢参与</div>
                      <img class="pic-one pic" @click.stop="editDetails('prize6bg',PageConfig.prize6bg)" src="../../assets/lottery/EhcThanks.png"/>
                    </li>
                    <li>
                      <div class="name-two name" :class="{'choosedArea':PageConfig.prize7name.IsChoosed}" @click.stop="editDetails('prize7name',PageConfig.prize7name)" :style="{color:PageConfig.prize7name.NewColorName16?PageConfig.prize7name.NewColorName16:PageConfig.prize7name.ColorName16}" >咖啡机</div>
                      <img class="pic-two pic" @click.stop="editDetails('prize7bg',PageConfig.prize7bg)" src="../../assets/lottery/coffee.png"/>
                    </li>
                    <li>
                      <div class="name-three name" :class="{'choosedArea':PageConfig.prize8name.IsChoosed}" @click.stop="editDetails('prize8name',PageConfig.prize8name)" :style="{color:PageConfig.prize8name.NewColorName16?PageConfig.prize8name.NewColorName16:PageConfig.prize8name.ColorName16}" >毛球修剪器</div>
                      <img class="pic-three pic" @click.stop="editDetails('prize8bg',PageConfig.prize8bg)" src="../../assets/lottery/trimmer.png"/>
                    </li>
                    <li>
                      <div class="name-four name" :class="{'choosedArea':PageConfig.prize1name.IsChoosed}" @click.stop="editDetails('prize1name',PageConfig.prize1name)" :style="{color:PageConfig.prize1name.NewColorName16?PageConfig.prize1name.NewColorName16:PageConfig.prize1name.ColorName16}" >咖啡机</div>
                      <img class="pic-four pic" @click.stop="editDetails('prize1bg',PageConfig.prize1bg)" src="../../assets/lottery/coffee.png"/>
                    </li>
                    <li>
                      <div class="name-five name" :class="{'choosedArea':PageConfig.prize2name.IsChoosed}" @click.stop="editDetails('prize2name',PageConfig.prize2name)" :style="{color:PageConfig.prize2name.NewColorName16?PageConfig.prize2name.NewColorName16:PageConfig.prize2name.ColorName16}" >谢谢参与</div>
                      <img class="pic-five pic" @click.stop="editDetails('prize2bg',PageConfig.prize2bg)" src="../../assets/lottery/EhcThanks.png"/>
                    </li>
                    <li>
                      <div class="name-six name" :class="{'choosedArea':PageConfig.prize3name.IsChoosed}" @click.stop="editDetails('prize3name',PageConfig.prize3name)" :style="{color:PageConfig.prize3name.NewColorName16?PageConfig.prize3name.NewColorName16:PageConfig.prize3name.ColorName16}" >毛球修剪器</div>
                      <img class="pic-six pic" @click.stop="editDetails('prize3bg',PageConfig.prize3bg)" src="../../assets/lottery/trimmer.png"/>
                    </li>
                    <li>
                      <div class="name-seven name" :class="{'choosedArea':PageConfig.prize4name.IsChoosed}" @click.stop="editDetails('prize4name',PageConfig.prize4name)" :style="{color:PageConfig.prize4name.NewColorName16?PageConfig.prize4name.NewColorName16:PageConfig.prize4name.ColorName16}" >咖啡机</div>
                      <img class="pic-seven pic" @click.stop="editDetails('prize4bg',PageConfig.prize4bg)" src="../../assets/lottery/coffee.png"/>
                    </li>
                    <li>
                      <div class="name-eight name" :class="{'choosedArea':PageConfig.prize5name.IsChoosed}" @click.stop="editDetails('prize5name',PageConfig.prize5name)" :style="{color:PageConfig.prize5name.NewColorName16?PageConfig.prize5name.NewColorName16:PageConfig.prize5name.ColorName16}" >毛球修剪器</div>
                      <img class="pic-eight pic" @click.stop="editDetails('prize5bg',PageConfig.prize5bg)" src="../../assets/lottery/trimmer.png"/>
                    </li>
                  </ul>
                </div>
              </div>
              <p
                ...
                v-html="PageConfig.bottomrule.NewDesName?PageConfig.bottomrule.NewDesName:PageConfig.bottomrule.DesName"
              ></p>
                  ...
                  <div class="mask">
                    ...
                    <div class="maskContent">
                      <h1
                        ...
                        v-html="PageConfig.nogifttitle.NewDesName?PageConfig.nogifttitle.NewDesName:PageConfig.nogifttitle.DesName"
                        @click.stop="editDetails('nogifttitle',PageConfig.nogifttitle)"
                      ></h1>
                      <p
          ...
          <div class="editWrap">
            <div class="editContent scollWrap">
              ...
              <template v-if="editConfig.FormType==2">
                ...
                <v-editor ref="editor" :catchData="catchData" :html-content="editConfig.NewDesName?editConfig.NewDesName:editConfig.DesName"></v-editor>
              </template>
              ...
              <template v-if="editConfig.FormType==4">
                ...
                <v-color-picker
                  ref="pickcolor"
                  v-on:pick="pickColor"
                  :init-color="editConfig.NewColorName16?editConfig.NewColorName16:editConfig.ColorName16"
                  :label-text="'编辑颜色'"
                ></v-color-picker>
              </template>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      editConfig: "", //编辑配置内容
      isHide:false,//转盘奖品背景修改后隐藏choosedArea
    };
  },
  components: {
    "v-upload": UploadImg,
  ...
  methods: {
    ...
    //给页面配置元素增加 IsChoosed属性:代表元素是否选中, IsUpdated属性:代表元素是否更新修改过 0否 1是
    addProperty() {
      _.mapKeys(this.PageConfig, (value, key) => {
        this.PageConfig[key].IsChoosed = false;
        this.PageConfig[key].IsUpdated = 0;
      });
    },
    getSrc(src) {
    ...
    saveFile(src) {
      ...
      this.editConfig.IsUpdated = 1;
      this.PageConfig[this.editorType] = this.editConfig;
    },
    //删除已上传的图片
    deleteUpImg(config) {
      this.editConfig.NewImgUrl = "";
      this.editConfig.IsUpdated = 0;
      this.PageConfig[this.editorType] = this.editConfig;
      // 动态改变对象 & 克隆
    ...
    pickColor(color) {
      ...
      this.isHide = false;
      //转盘背景修改后，隐藏choosedArea
      if(this.editorType.substring(0,5)=="prize"&&this.editorType.indexOf('bg')==6){
        this.isHide = true;
      }

      // //转盘奖品配置修改 需要绑定到drawList
      // if(this.editorType.substring(0,5)=="prize"&&this.editorType.indexOf('bg')==6){
      //   var index=parseInt(this.editorType.substring(5,6))-1;
      //   if(index<this.drawList.length){
      //     this.drawList[index].bg = color;
      //   }
      // }
      // if(this.editorType.substring(0,5)=="prize"&&this.editorType.indexOf('name')==6){
      //   var index=parseInt(this.editorType.substring(5,6))-1;
      //   if(index<this.drawList.length){
      //     this.drawList[index].color = color;
      //   }
      // }
    },
    //获取基础模板的页面列表
      ...
      this.$post("/api/crmModuleTempletePageConfig/GetListBySC", data).then(
        res => {
          ...
          if (res.state == 1) {
            ...
            //给页面元素增加 是否选中属性 以及 元素是否更新修改过属性 默认第一条数据选中
    ...
    cancelEdit() {
      ...
      if (this.$refs.upload) {
        this.$refs.upload.uploadList = [];
        this.PageConfig[this.editorType].NewImgUrl = "";
        this.PageConfig[this.editorType].IsUpdated = 0;
      } else if (this.$refs.editor) {
        this.$refs.editor.editorContent = "";
        this.$refs.editor.htmlContent = "";
        this.PageConfig[this.editorType].NewDesName = "";
        this.PageConfig[this.editorType].IsUpdated = 0;
      } else if(this.$refs.pickcolor){
        this.$refs.pickcolor.initColor = "";
        this.PageConfig[this.editorType].NewColorName16 = "";
        this.PageConfig[this.editorType].IsUpdated = 0;
      }
      // 动态改变对象 & 克隆
      var pageConfigStr = JSON.stringify(this.PageConfig);
